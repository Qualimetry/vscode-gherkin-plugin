...
class ConsistentIndentationCheckTest {
    ...
    @Test
    void shouldNotRaiseIssueOnCorrectlyIndentedDocStringDelimiters() {
        CheckVerifier.verifyNoIssues(
                new ConsistentIndentationCheck(),
                "checks/consistent-indentation/docstring-compliant.feature");
    }

    @Test
    void shouldRaiseIssueOnIncorrectlyIndentedDocStringDelimiters() {
        CheckVerifier.verify(
                new ConsistentIndentationCheck(),
                "checks/consistent-indentation/docstring-noncompliant.feature");
    }
