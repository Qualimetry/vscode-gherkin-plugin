...
class NoTrailingWhitespaceCheckTest {
    ...
    @Test
    void shouldNotRaiseIssueOnCleanLines() {
        CheckVerifier.verifyNoIssues(
                new NoTrailingWhitespaceCheck(),
                "checks/no-trailing-whitespace/compliant.feature");
    }

    @Test
    void shouldRaiseIssueOnTrailingWhitespace() {
        CheckVerifier.verify(
                new NoTrailingWhitespaceCheck(),
                "checks/no-trailing-whitespace/noncompliant.feature");
    }
}
