...
class RequiredTagsCheckTest {
    ...
    @Test
    void shouldNotRaiseIssueWhenFeatureTagMatches() {
        RequiredTagsCheck check = new RequiredTagsCheck();
        check.setPattern("smoke|regression");
        CheckVerifier.verifyNoIssues(check,
                "checks/required-tags/inherited-tags-compliant.feature");
    }

    @Test
    void shouldNotRaiseIssueWhenRuleTagMatches() {
        RequiredTagsCheck check = new RequiredTagsCheck();
        check.setPattern("smoke|regression");
        CheckVerifier.verifyNoIssues(check,
                "checks/required-tags/inherited-rule-tags-compliant.feature");
    }
}
