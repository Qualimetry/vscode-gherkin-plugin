...
class EvidenceReportTest {
    ...
    void generateEvidenceReport() throws Exception {
        ...
        // Exclude fixtures verified by their rule's dedicated test (e.g. no-multiple-empty-lines
        // reports on a blank line where the standard annotation cannot be placed).
        Set<String> customVerifiedFixtures = Set.of("no-multiple-empty-lines/noncompliant.feature");
