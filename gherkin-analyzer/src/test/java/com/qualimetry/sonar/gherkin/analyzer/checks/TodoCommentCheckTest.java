...
class TodoCommentCheckTest {
    ...
    @Test
    void shouldNotRaiseIssueWhenNoTodoComments() {
        CheckVerifier.verifyNoIssues(
                new TodoCommentCheck(),
                "checks/todo-comment/compliant.feature");
    }

    @Test
    void shouldRaiseIssueOnTodoComment() {
        CheckVerifier.verify(
                new TodoCommentCheck(),
                "checks/todo-comment/noncompliant.feature");
    }
}
