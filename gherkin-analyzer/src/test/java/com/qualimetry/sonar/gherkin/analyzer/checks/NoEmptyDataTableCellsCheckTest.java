...
class NoEmptyDataTableCellsCheckTest {

    @Test
    void shouldNotRaiseIssueForPopulatedCells() {
        CheckVerifier.verifyNoIssues(
                new NoEmptyDataTableCellsCheck(),
                "checks/no-empty-data-table-cells/compliant.feature");
    }
    ...
    void shouldRaiseIssueForEmptyCell() {
        CheckVerifier.verify(
                new NoEmptyDataTableCellsCheck(),
                "checks/no-empty-data-table-cells/noncompliant.feature");
    }
}
