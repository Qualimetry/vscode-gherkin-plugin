    ...
    public void visitFeatureFile(FeatureFile file) {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (currentBlank && previousBlank) {
                // Report on the extra blank line (1-based). Loop index i is 0-based.
                addLineIssue(i + 1, "Remove this unnecessary blank line; only one consecutive blank line is allowed.");
            }
