...
/**
 * Central registry of all 86 Gherkin analysis checks.
 * <p>
...
public final class CheckList {
    ...
    /**
     * Returns all 86 check classes in registration order.
     */
    public static List<Class<? extends BaseCheck>> getAllChecks() {
        return List.of(
                ...
                NoEmptyDataTableCellsCheck.class,
                ExamplesConstantColumnCheck.class
        );
    }
    ...
    public static List<String> getDefaultRuleKeys() {
        return List.of(
                ...
                // Additional default-active rules (84, 86)
                "max-line-length",
