 ...
 * @param parseFailed {@code true} when the parser could not produce a document
 *                    (syntax error); {@code false} for a successfully parsed
 *                    file, even one without a Feature declaration
 */
public record FeatureFile(
    ...
    public FeatureFile(FeatureDefinition feature, List<Comment> comments, String language, String uri) {
        this(feature, comments, language, uri, false);
    }
}
