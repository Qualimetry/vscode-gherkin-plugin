...
public class FeatureParser {
     ...
     *         is empty, contains only comments, or has parse errors, and
     *         {@link FeatureFile#parseFailed()} is {@code true} only in the
     *         parse-error case
    ...
    public FeatureFile parse(String uri, InputStream content) throws IOException {
        ...
        if (doc == null) {
            ...
            return new FeatureFile(null, List.of(), "en", uri, true);
        }
