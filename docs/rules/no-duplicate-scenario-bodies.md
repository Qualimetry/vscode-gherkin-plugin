...
- `no-duplicate-steps` - flags a step repeated inside one scenario.
- `unique-scenario-name` - requires scenario names to differ.
- `use-scenario-outline-for-examples` - replaces near-identical scenarios with an outline.
