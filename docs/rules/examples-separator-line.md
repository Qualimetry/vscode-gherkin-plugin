...
- `blank-line-before-scenario` - applies the same visual separation to scenarios.
- `no-multiple-empty-lines` - prevents the opposite problem of excessive blank lines.
